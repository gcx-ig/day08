...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="username" class="form-control" id="txt_search_expressName" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">公司</span>
					<select class="form-control" name="txt_search_roleid" id = "txt_search_id">
			   ...
			   <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="date" name="entryTime" class="form-control" id="txt_search_entryTime1" >-
			      <input type="date" name="entryTime" class="form-control" id="txt_search_entryTime2" >
				</div>
			  </div>
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>特长：</td>
								<td colspan="4">
									<input type="checkbox" id="expressTrait1" name="expressTrait" value="耐心"
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_import" method="post" action="importPer.htm" enctype="multipart/form-data">
						导入<input type="file" name="newFile" id="newFile">
	...
	function initEditUser(getSelection){
		...
		var e =getSelection.expressTrait;
		if(e.indexOf("干练")!=-1){
