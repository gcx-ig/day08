        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="date" name="sBirth" class="form-control" id="txt_search_sBirth1" >-
			      <input type="date" name="sBirth" class="form-control" id="txt_search_sBirth2" >
				</div>
			  </div>
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>爱好：</td>
								<td colspan="4">
									<input type="checkbox" id="sHobby1" name="sHobby" value="篮球"
									class="" aria-required="true" required/>篮球
									<input type="checkbox" id="sHobby2" name="sHobby" value="足球"
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            sBirth2: $("#txt_search_sBirth1").val(),
